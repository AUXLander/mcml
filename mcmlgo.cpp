...
// ****/
//void Spin(const double anisotropy, PhotonStruct* Photon_Ptr)
//{
...
//{
//	double step_size = Photon_Ptr->step_size;
//
//	Photon_Ptr->x += step_size * Photon_Ptr->ux;
//	Photon_Ptr->y += step_size * Photon_Ptr->uy;
//	Photon_Ptr->z += step_size * Photon_Ptr->uz;
//}
...
//
//		Photon_Ptr->step_size = -log(rnd) / (mua + mus);
//	}
//	else /* take the leftover. */
//	{
//		Photon_Ptr->step_size = Photon_Ptr->sleft / (mua + mus);
 ...
 ****/
//bool HitBoundary(PhotonStruct* Photon_Ptr, InputStruct* In_Ptr)
//{
...
//		{
//			Photon_Ptr->uz = -uz1;
//			Photon_Ptr->RecordR(0.0, In_Ptr, Out_Ptr);
//			Photon_Ptr->dead = 1;
//		}
//		else
//		{
...
//		{
//			Photon_Ptr->uz = uz1;
//			Photon_Ptr->RecordT(0.0, In_Ptr, Out_Ptr);
//			Photon_Ptr->dead = 1;
//		}
//		else
//		{
...
//	{
//		Photon_Ptr->CrossUpOrNot(In_Ptr, Out_Ptr);
//	}
//	else
//	{
//		Photon_Ptr->CrossDnOrNot(In_Ptr, Out_Ptr);
//	}
//}
...
//	else
//	{
//		Photon_Ptr->StepSizeInGlass(In_Ptr);
//		Photon_Ptr->Hop(); // Move the photon s away in the current layer of medium. 
//		Photon_Ptr->CrossOrNot(In_Ptr, Out_Ptr);
//	}
//}
...
//
//	const auto hit = HitBoundary(Photon_Ptr, In_Ptr);
//
...
//		Spin(In_Ptr->layerspecs[Photon_Ptr->layer].anisotropy, Photon_Ptr);
//	}
//}
...
//	{
//		/* glass layer. */
//		Photon_Ptr->HopInGlass(In_Ptr, Out_Ptr);
//	}
//	else
//	{
...
//
//		//
//		const auto hit = Photon_Ptr->HitBoundary(In_Ptr);
//
//		Photon_Ptr->Hop();	/* move to boundary plane. */
//
//		if (hit)
//		{
//			Photon_Ptr->CrossOrNot(In_Ptr, Out_Ptr);
...
//		else
//		{
//			Photon_Ptr->Drop(In_Ptr, Out_Ptr);
//			Photon_Ptr->spin(In_Ptr->layerspecs[Photon_Ptr->layer].anisotropy);
//		}
//	}
//
